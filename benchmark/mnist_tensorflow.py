...
def benchmark(final_activation_layer):
    # data
    ...
    with tf.name_scope('loss_function'):
        with tf.name_scope('final_activation'):
            soft_max = final_activation_layer(tf.matmul(x, W) + b)
...
# benchmark(tf.nn.softmax)
benchmark(tf.nn.sigmoid)
